...
def builder_inited(app):
    ...
    app.info('Using netappdocstheme Sphinx theme from %s' % theme_dir)
...
def get_pdf_theme_path():
    ...
    args = ['theme', 'netappdocs_pdf', 'pdftheme']
...
def get_openstack_logo_path():
    ...
    args = ['theme', 'netappdocs_pdf', 'openstack-logo-full.png']
    return os.path.join(get_pkg_path(), *args)
...
def setup(app):
    app.info('connecting events for netappdocstheme')
