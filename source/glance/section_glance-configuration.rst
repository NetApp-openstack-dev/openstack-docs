...
.. toctree::
   ...
   configuration/section_netapp-config.rst
   configuration/section_enhanced-instance.rst
...
``glance-api`` service).
   ...
   ::
      ...
      $ sudo openstack-config --get /etc/glance/glance-api.conf DEFAULT filesystem_store_datadir
   ...
   ::
      ...
      $ sudo cat /etc/glance/glance-api.conf|grep filesystem_store_datadir|egrep -v "^#.*"
