...
-  *netapp:qos_policy_group*: A Cinder extra-spec, which references an
   ...
   backend prior to specifying the netapp:qos\_policy\_group option in a
...
.. warning::
   The NetApp Unified Cinder Driver does not support advantaged driver optimized retype operations.
