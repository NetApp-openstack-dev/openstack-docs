...
display name or UUID. Please review Cinder release notes, for upgrade 
instructions, prior to using group operations.

.. note::
   Only the Block Storage V3 API supports group operations. You can specify the API 
   version ``--os-volume-api-version 3.14``, for the CLI client, to access the group 
   API. 
...
.. note::
   ...
   ``consistent_group_snapshot_enabled="<is> True"`` in the group type. 
