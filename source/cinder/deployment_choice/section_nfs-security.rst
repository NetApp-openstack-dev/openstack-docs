...
need to belong to the same cinder GID (510) as used by the cinder service.
...
7) Disable superuser access in export policy.
...
8) Set exported Flexvol owner and group.
...
9) Set exported Flexvol permissions.
...
10) Update file permissions to 0660.
